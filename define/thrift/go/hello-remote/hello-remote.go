...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  HelloResponse Say(HelloRequest hello)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  client := go.NewHelloClient(thrift.NewTStandardClient(iprot, oprot))
  ...
  case "Say":
    ...
    value0 := argvalue0
    fmt.Print(client.Say(context.Background(), value0))
    fmt.Print("\n")
    break
  case "":
    Usage()
